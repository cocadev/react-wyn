            ...
            <div className="container">
                <center>
                    <div className="col-lg-12 text-center m-b-lg">
                        ...
                        <Fade top><center><div className="f-24">{data.SECTION3_TITLE} </div></center></Fade>
                    </div>
                </center>
                <Fade left>
                    <div className="col-lg-6 text-center flex-center m-t-xl">
                        <div className="f-24 text-center" style={{ marginLeft: 12 }}> Lowest Cost </div>
                        <div style={{ height: '314px', width: '314px', position: 'relative', }}>
                            ...
                            >
                                <div 
                                    className='mydots' 
                                    style={{ background: activeDrags ? 'lightgrey' : '#ffc200' }}
                                />
                            </Draggable>
                            <div className='box' />
                        </div>
                        <div className='container-row tri-view'>
                            <div className="f-24 m-t">Fastest Response</div>
                            <div className="f-24 m-t">Highest Quality</div>
                        </div>
...
// classname modifier style={{ fontSize: props.title1 === 'Technician' && 17 }}
